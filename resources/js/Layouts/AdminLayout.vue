        ...
        <ul class="space-y-2 tracking-wide mt-8">
            <li>
                <Link 
                    ...
                    aria-label="usuarios" 
                    class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-gray-600 bg-gradient-to-r"
                    :class="{'from-sky-600':route().current('users.*'), 'to-cyan-400':route().current('users.*'), 'text-white':route().current('users.*')}">
            ...
            <li>
                <Link 
                    ...
                    :class="{'from-sky-600':route().current('roles.*'), 'to-cyan-400':route().current('roles.*'), 'text-white':route().current('roles.*')}">
            ...
            <li>
                <Link 
                    ...
                    class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group bg-gradient-to-r"
                    :class="{'from-sky-600':route().current('permissions.*'), 'to-cyan-400':route().current('permissions.*'), 'text-white':route().current('permissions.*')}">
